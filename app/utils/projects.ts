export const projects: Array<Project> = [
  {
    ...
    technologies: ['Vue.js', 'Nuxt', 'Javascript', 'Vuetify', 'Spring Boot', 'oAuth 2', 'PostgreSQL', 'Docker']
  },

  {
    ...
    technologies: ['Vue.js', 'Javascript', 'Vuetify', 'D3js', 'Node.js', 'Fastify', 'PostgreSQL', 'MongoDB', 'Docker', 'Pyton']
  },

  {
    ...
    description: [
      'Ein Vue.js Framework das von anderen Entwicklerteams im Unternehmen genutzt wird um verschiedenste TAA (Tarif-Angebot-Antrag) Formulare zu erstellen.'
    ],
    myWork: [
    ...
    technologies: ['Vue.js', 'HTML 5', 'SASS', 'Spring Boot', 'Vitest', 'Storybook', 'Vuex']
  },

  {
    ...
    technologies: ['Vue.js', 'Nuxt', 'HTML 5', 'SASS', 'Capacitor', 'Vitest', 'Spring Boot', 'Pinia']
  },
...

  {
    ...
    technologies: ['Vue.js', 'Nuxt', 'HTML 5', 'SASS', 'Typescript', 'Cypress', 'Docker', 'Java', 'Spring Boot', 'Jest', 'Keycloak', 'MySQL', 'Storybook', 'Vuex']
  },
...

  {
    ...
    industry: 'Softwareentwicklung',
    myRole: 'Frontend Entwickler',
    description: ['Umsetzung verschiedener Unternehmensauftritte'],
    myWork: [
      'Durchführung der Entwicklung',
      'Design Beratung',
    ],
    technologies: ['Vue.js', 'Nuxt', 'Javascript', 'HTML 5', 'CSS 3', 'Wordpress']
  },
